...
public:
    ...
    std::vector<Big_Number> method_Ferma();
    Big_Number p_method_polarda_factorize() const;
    Big_Number p_minus_1_method_polarda_factorize() const;
    Big_Number algorithm_evklida(const Big_Number & n) const;
    Big_Number nth_sqrt(const Big_Number& n) const;
    Big_Number log2() const;
    int find_highest_bit_position() const;
};
