...
def montgomery_exponentiation_manual():
    """
    Позволяет вручную вводить данные и выводит результаты в консоль.
    """
    # Ввод данных
    x = int(input("Введите основание степени x: "))
    ...
    print(f"Результат возведения в степень по модулю: {result}")

# Пример использования
montgomery_exponentiation_manual()
